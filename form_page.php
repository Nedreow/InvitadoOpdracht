...
<body>
    <div>
        ...
        <form action="success_page.php" method="post" class="info-form">
            <div class="form-row">
                <div>
                    ...
                    <select name="salutation" id="salutation-select">
                        ...
                        <option value="2">heer</option>
                        <option value="3">mevrouw</option>
                        <option value="1">anders namelijk:</option>
                    </select>
                </div>

                <div>
                    <label for="salutation-other" hidden></label>

                    <input type="text" name="salutation" id="salutation-other">
                </div>
            </div>
